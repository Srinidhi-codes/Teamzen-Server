...
**Learn (concepts + identity bind):** [`docs/backend/14-mcp.md`](../../docs/backend/14-mcp.md) · [15 Guardrails](../../docs/backend/15-guardrails.md)
...
- `MCP_INTERNAL_SECRET` — match the MCP process
- `MCP_MULTI_SERVER=false`

MCP process env (match Django secret): `MCP_INTERNAL_SECRET`, and `MCP_AUTH_REQUIRED=true` in production.
